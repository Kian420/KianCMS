	...
	<div class="divider" style="min-height:100px;">
		<img src="img/avatar.png" width="80px" style="float:left;margin:0px 5px 20px 5px;">
		<?php
	...
	<h2>OUR SERVER</h2>
	<div class="divider" style="text-align:center;font-weight:bold;">
	<?php
...
<br />
	<?php
		$sql2="SELECT online FROM $dbnamec WHERE online=1";
	if($result = mysqli_query(mysqli_connect($servername, $username, $password, $dbnamec), $sql2)){
  ...
  ?> / 1000<br />
	...
	<?php
		$sql = "SELECT * FROM $dbnamec ORDER BY totalKills DESC LIMIT 5";
