...
$dbnamec = "' . $_POST['dbnamec'] . '"; //DBName for characters database
$dbnamea = "' . $_POST['dbnamea'] . '"; //DBName for auth database
...
$con = new mysqli($_POST['dbhost'], $_POST['dbusername'], $_POST['dbpassword'], $_POST['dbnamea']);
if (!$conn) {
...
$sql = "ALTER TABLE `account` ADD `web_admin` LONGTEXT NOT NULL COMMENT '1-3' AFTER `recruiter`";
